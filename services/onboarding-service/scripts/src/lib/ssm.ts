...
export async function getOnboardingServiceBaseUrl() {
  const value = process.env.ONBOARDING_SERVICE_BASE_URL
    ?? await getParameter("/services/onboarding-service/base-url");
